...
CREATE TABLE Transactions(trans_id int IDENTITY(1,1) PRIMARY KEY, card_id varchar(16), store_id varchar(15), trans_date datetime, trans_amount float, trans_category varchar(20), trans_status bit, response_id varchar(10), status_time datetime, encrypted bit, self bit);
